...
<xsl:template match="/">
    ...
    <body class="bg-gray-50 text-gray-800 font-sans selection:bg-accent selection:text-white min-h-screen">
        <!-- 头部区域 -->
        <header class="bg-gradient-to-r from-primary to-secondary text-white shadow-md py-4">
        ...
        <!-- 主内容区 -->
        <main class="max-w-content mx-auto px-4 py-6 sm:py-8 md:py-12 mt-6">
            <!-- 双栏文章列表（移动端为单栏） -->
        ...
        <!-- 页脚 -->
        <footer class="bg-dark text-gray-300 mt-16 py-4">
